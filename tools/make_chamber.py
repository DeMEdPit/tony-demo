...
BRAIN_KIND = None          # --brain-kind: the slot's kind byte as assembled (tony-body-builder.prg is 2);
                           #   unset it is 0, or 1 for --brain025, whose blank brain idles through the forward pass
