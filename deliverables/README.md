...
| `tony-chamber-the-shadow.prg` | 40,248 | the same build with the token's behaviour and a provisional colour stamped: The Shadow (Follow, green): keeps his distance, faces Tony, hops when Tony jumps. `tools/verify_buddy.py` is the scripted test of all seven |
